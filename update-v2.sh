...
if [[ -e /usr/local/bin/xray ]]; then
	 ...
	 wget -O add-tr "https://raw.githubusercontent.com/apih46/yourpath/main/XRAY/add-tr.sh" && chmod +x add-tr
	 wget -O add-vless "https://raw.githubusercontent.com/apih46/yourpath/main/XRAY/add-vless.sh" && chmod +x add-vless
	 wget -O add-ws "https://raw.githubusercontent.com/apih46/yourpath/main/XRAY/add-ws.sh" && chmod +x add-ws
	 wget -O user-tr "https://raw.githubusercontent.com/apih46/yourpath/main/XRAY/user-tr.sh" && chmod +x user-tr
	 wget -O user-vless "https://raw.githubusercontent.com/apih46/yourpath/main/XRAY/user-vless.sh" && chmod +x user-vless
	 ...
	 sleep 1
     mv /usr/local/bin/xray /usr/local/bin/xray.bak && wget -q -O /usr/local/bin/xray "https://github.com/Tomyam/Xcore-custompath/releases/download/v1.0.0/xray.linux.64bit" && chmod 755 /usr/local/bin/xray
	 echo ""
	 ...
	 sleep 1
	 rm -rf /usr/local/sbin/helium
	 wget -q -O /usr/local/sbin/helium https://raw.githubusercontent.com/apih46/yourpath/main/helium.sh
	 cd /usr/bin
	 rm nf
	 rm ins-helium
	 rm limit
